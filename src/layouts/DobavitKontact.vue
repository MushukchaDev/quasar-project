<template>
    <div class="q-gutter-md" style="max-width: 300px">
        ...
        <q-checkbox dense v-model="obrat_sort" stack-label label="Из адресной книги?" color="dark" />
        <q-input outlined v-model="text4" dense stack-label label="Мобильный" placeholder="Номер телефона" />
        <q-btn :ripple="false" color="dark" label="Сохранить" no-caps />
        <q-btn :ripple="false" outline color="dark" label="Сбросить" no-caps />
    </div>
</template>
